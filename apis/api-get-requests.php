...
WHERE bookings.dog_sitter_fk IN (SELECT users.id from users WHERE users.email = :sUserEmail)' );
...
if($aRows==[]){
    $sAllResultsString = "<tr><td colspan='6' style='color: lightgray;'>No requests yet</td></tr>";
}
